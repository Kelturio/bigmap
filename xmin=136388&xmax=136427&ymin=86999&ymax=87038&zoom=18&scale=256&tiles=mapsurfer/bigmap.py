#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136388&xmax=136427&ymin=86999&ymax=87038&zoom=18&scale=256&tiles=mapsurfer

import io, urllib2, datetime, time, re, random
from PIL import Image, ImageDraw
# ^^^^^^ install "python-pillow" package | pip install Pillow | easy_install Pillow

(zoom, xmin, ymin, xmax, ymax) = (18, 136388, 86999, 136427, 87038)
layers = ["http://korona.geog.uni-heidelberg.de/tiles/roads/x=!x&y=!y&z=!z"]
attribution = 'Map data (c) OpenStreetMap, Tiles (c) GIScience Heidelberg'
xsize = xmax - xmin + 1
ysize = ymax - ymin + 1
