#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136388&xmax=136427&ymin=86999&ymax=87038&zoom=18&scale=256&tiles=humanitarian
...
layers = ["http://{abc}.tile.openstreetmap.fr/hot/!z/!x/!y.png"]
attribution = 'Map data (c) OpenStreetMap, Tiles (c) Humanitarian OSM Team'
xsize = xmax - xmin + 1
ysize = ymax - ymin + 1
