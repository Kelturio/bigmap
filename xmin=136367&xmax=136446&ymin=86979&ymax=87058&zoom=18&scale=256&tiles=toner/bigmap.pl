#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136367&xmax=136446&ymin=86979&ymax=87058&zoom=18&scale=256&tiles=toner

use strict;
use LWP;
use GD;

my ($zoom, $xmin, $ymin, $xmax, $ymax) = (18, 136367, 86979, 136446, 87058);
