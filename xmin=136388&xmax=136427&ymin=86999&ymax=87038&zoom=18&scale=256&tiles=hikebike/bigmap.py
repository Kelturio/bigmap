#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136388&xmax=136427&ymin=86999&ymax=87038&zoom=18&scale=256&tiles=hikebike
...
layers = ["http://toolserver.org/tiles/hikebike/!z/!x/!y.png"]
attribution = 'Map data (c) OpenStreetMap, Tiles (c) Colin Marquardt'
xsize = xmax - xmin + 1
ysize = ymax - ymin + 1
