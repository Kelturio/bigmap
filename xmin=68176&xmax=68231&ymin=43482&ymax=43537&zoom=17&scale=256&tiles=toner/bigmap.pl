#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=68176&xmax=68231&ymin=43482&ymax=43537&zoom=17&scale=256&tiles=toner

use strict;
use LWP;
use GD;

my ($zoom, $xmin, $ymin, $xmax, $ymax) = (17, 68176, 43482, 68231, 43537);
