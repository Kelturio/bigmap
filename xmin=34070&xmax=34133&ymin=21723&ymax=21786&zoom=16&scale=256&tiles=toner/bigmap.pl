#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=34070&xmax=34133&ymin=21723&ymax=21786&zoom=16&scale=256&tiles=toner

use strict;
use LWP;
use GD;

my ($zoom, $xmin, $ymin, $xmax, $ymax) = (16, 34070, 21723, 34133, 21786);
