#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=17019&xmax=17082&ymin=10845&ymax=10908&zoom=15&scale=256&tiles=toner

use strict;
use LWP;
use GD;

my ($zoom, $xmin, $ymin, $xmax, $ymax) = (15, 17019, 10845, 17082, 10908);
