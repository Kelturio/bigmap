#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136388&xmax=136427&ymin=86999&ymax=87038&zoom=18&scale=256&tiles=sputnik
...
layers = ["http://{abcd}.tiles.maps.sputnik.ru/!z/!x/!y.png"]
attribution = 'Map data (c) OpenStreetMap, Tiles (c) Sputnik'
xsize = xmax - xmin + 1
ysize = ymax - ymin + 1
