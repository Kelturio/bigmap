#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136392&xmax=136423&ymin=87003&ymax=87034&zoom=18&scale=256&tiles=toner

use strict;
use LWP;
use GD;

my ($zoom, $xmin, $ymin, $xmax, $ymax) = (18, 136392, 87003, 136423, 87034);
my @layers = ('http://{abc}.tile.stamen.com/toner/!z/!x/!y.png');
my $attribution = 'Map data (c) OpenStreetMap, Tiles (c) Stamen Design';
