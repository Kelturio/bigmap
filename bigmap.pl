#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136388&xmax=136427&ymin=86999&ymax=87038&zoom=18&scale=256&tiles=osm-fr
...
my @layers = ('http://{abc}.tile.openstreetmap.fr/osmfr/!z/!x/!y.png');
my $attribution = 'Map data (c) OpenStreetMap, Tiles (c) OSM France';
