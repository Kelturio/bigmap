#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=136388&xmax=136427&ymin=86999&ymax=87038&zoom=18&scale=256&tiles=transport
...
my @layers = ('http://{abc}.tile2.opencyclemap.org/transport/!z/!x/!y.png');
