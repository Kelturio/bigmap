#!/usr/bin/perl
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=68189&xmax=68218&ymin=43495&ymax=43524&zoom=17&scale=256&tiles=osm-de
...
my @layers = ('http://{abc}.tile.openstreetmap.de/tiles/osmde/!z/!x/!y.png');
my $attribution = 'Map data (c) OpenStreetMap, Tiles (c) OSM DE';
